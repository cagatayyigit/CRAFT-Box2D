...
public:
    ...
    virtual void DrawTexturedSolidPolygon(const b2Vec2* vertices, const b2Vec2* textureCoordinates, uint32 glTexId, int matTexId, int32 vertexCount, const b2Color& color) = 0;
