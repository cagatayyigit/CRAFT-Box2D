...
namespace svqa {
	...
	public:
		...
		void InitializeScene() override {
			...
			// Basket
			AddTargetBasket(b2Vec2(RandomFloat(17, 20), -1.2f), 0.0f);
			...
			AddStaticObject(b2Vec2(  7.0f, RandomFloat(8, 9)), 7 * M_PI / 8, SimulationObject::STATIC_PLATFORM);  //  8 < y < 9

            
            float x = RandomFloat(11, 33);
